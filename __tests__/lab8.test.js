...
describe('Basic user flow for Website', () => {
	...
	it('Clicking the "Add to Cart" button should change button text', async () => {
		...
		const produceItem = await page.$('product-item');
		...
		const innerTextRaw = await innerText.jsonValue();
		expect(innerTextRaw).toBe('Remove from Cart');
	...
	it('Checking number of items in cart on screen', async () => {
		...
		const cartCounterJson = await cartCounter.jsonValue();
		expect(cartCounterJson.innerHtml).toEqual(20);
